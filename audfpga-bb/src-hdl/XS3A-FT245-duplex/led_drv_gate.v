...
// for clock 20 ns, 1000 ns / 20 ns = 500;
// so counter up to 512=2^9
// 1ms ok for stream rd, but not for typing..
// 10 ms => 5000 steps; 8192=2^13 ; visible typing, but not too much
// 50 ms => 25000 steps; 32768=2^15 ; still a bit too little on typing
// 100 ms => 50000 steps; 65536=2^16 ; seems as goot as it gets
